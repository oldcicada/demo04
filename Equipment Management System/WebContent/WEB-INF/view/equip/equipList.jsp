...
<body>
	<div class="page-container">
		...
		<ul class="nav nav-tabs">
			<li class="active"><a href="view/equip/equipList"> 设备列表 </a></li>
			<li><a href="view/equip/equipForm"> 新增设备</a></li>
		</ul>
		<div class="row">
				...
				<table style="margin: 20px;">
					<tr>
						...
						<td><select name="type" class="form-control">
								...
								<c:forEach items="${equipTypes}" var="type">
						...
						<td><input type="text" class="form-control" name="name"
							placeholder="请输入设备名称" /></td>
						<td style="padding: 10px"></td>
						<td><label class="control-label">设备状态：</label></td>
						<td><select name="state" class="form-control">
								<option value="">请选择</option>
								<c:forEach items="${equipStates}" var="state">
	...
	<script type="text/javascript" src="resource/js/equipList.js"></script>
</body>
</html>
