		...
		<div class="page-container">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="view/sys/employeeForm">员工管理</a>
					</li>
				</ul>
			</div>
			<!-- END PAGE HEADER-->
			<ul class="nav nav-tabs">
				<li >
					<a href="view/sys/employeeList" >
					员工列表 </a>
				</li>
				<li class="active" >
					<a href="view/sys/employeeForm">
					新增员工 </a>
				</li>
			</ul>
			<!-- BEGIN PAGE CONTENT-->
			<div class="row">
				<div class="col-md-12">
							<!-- BEGIN FORM-->
							<form action="view/sys/employeeForm" method="post" class="form-horizontal">
								<div class="form-body">
